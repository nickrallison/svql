...
# yosys -p "verific -sv examples/fixtures/larger_designs/json/openpiton_tile.v" -p "hierarchy -top tile" -p proc -p memory -p opt_clean -p flatten -p "write_json examples/fixtures/larger_designs/json/openpiton_tile_full.json"
yosys -p "verific -sv examples/fixtures/larger_designs/verilog/openpiton_tile.v" -p "hierarchy -top tile" -p proc -p memory -p opt_clean -p "write_json examples/fixtures/larger_designs/json/openpiton_tile_partial.json"
gzip examples/fixtures/larger_designs/json/openpiton_tile_partial.json