...
/// Macro for defining composite queries (disjoint sub-queries over netlist instances).
...
/// - For full usage (with imports like `tracing` and query types), see `svql_query/src/queries/composite/...`.
///
