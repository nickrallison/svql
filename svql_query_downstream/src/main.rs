...
fn main() {
    ...
    println!("Found {} subgraph matches for needle {} in haystack {}.", matches.len(), needle_name_1, haystack_name);

    let matches = subgraph::find_subgraphs(&needle_design_2, &haystack_design);
    println!("Found {} subgraph matches for needle {} in haystack {}.", matches.len(), needle_name_2, haystack_name);

    let matches = subgraph::find_subgraphs(&needle_design_3, &haystack_design);
    println!("Found {} subgraph matches for needle {} in haystack {}.", matches.len(), needle_name_3, haystack_name);
    
    let matches = subgraph::find_subgraphs(&needle_design_4, &haystack_design);
    println!("Found {} subgraph matches for needle {} in haystack {}.", matches.len(), needle_name_4, haystack_name);
}
