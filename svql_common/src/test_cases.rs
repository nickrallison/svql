...
lazy_static::lazy_static! {
    ...
    static ref OR_2_SEQ_HAYSTACK: Haystack = Haystack {        yosys_module: YosysModule::new(
            "examples/patterns/basic/or/verilog/or_2_seq.v",            "or_2_seq",
        ).expect("Failed to create YosysModule for or_2_seq"),
    };

    static ref SINGLE_OR_HAYSTACK: Haystack = Haystack {        yosys_module: YosysModule::new(
            "examples/patterns/basic/or/verilog/or_gate.v",
            "or_gate",
        ).expect("Failed to create YosysModule for single OR"),
    };
    static ref NOT_GATE_HAYSTACK: Haystack = Haystack {        yosys_module: YosysModule::new(
            "examples/patterns/basic/not/verilog/not_gate.v",
            "not_gate",
        ).expect("Failed to create YosysModule for not_gate"),
    };
    static ref NOT_2_SEQ_HAYSTACK: Haystack = Haystack {        yosys_module: YosysModule::new(
