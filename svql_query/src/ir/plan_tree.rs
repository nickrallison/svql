...
use crate::traits::composite::Connections;
...
#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct NetlistPlanNode {
    pub key: DriverKey,
    pub config: Config,
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct CompositePlanNode {
    pub input_nodes: Vec<Box<PlanNode>>,
    pub constraints: Connections,
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct VariantPlanNode {
    pub input_nodes: Vec<Box<PlanNode>>,
}
